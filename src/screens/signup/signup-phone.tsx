...
type props = NativeStackScreenProps<RootStackParamList, 'SignupPhone'>;

const SignupPhone = (props: props) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <KeyboardAvoidScrollview
        ...
        <PrimaryButton
          title={'Next'}
          onPress={() => navigation.navigate('SignupCcNo')}
